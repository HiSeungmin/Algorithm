...
class Solution {
    ...
    private static List<int[]> extractShape(int startX, int startY, int row, int col, int[][] board, boolean[][] visited, int target){
    ...
    private static List<int[]> normalize(List<int[]> data){
